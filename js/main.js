     ...
     $('.zoom-click').click(function () {
         $(document).keyup(function (e) {
             if (e.keyCode === 27) {
                 ...
                 $('.arrow').removeClass('arrow-full');
                 $('.arrow-cover').removeClass('arrow-cover-full');
                 $('.arrow-point').removeClass('arrow-point-zoom');
         ...
         $('.arrow').toggleClass('arrow-full');
         $('.arrow-cover').toggleClass('arrow-cover-full');
         $('.arrow-point').toggleClass('arrow-point-zoom');
